...
const Sayhello = () => {
  return (
    <div className="mx-auto flex min-h-screen max-w-8xl flex-col items-center justify-start px-4 sm:px-6 lg:px-8">
      <h2 className="mb-10 text-center text-4xl font-bold lg:mb-20">
