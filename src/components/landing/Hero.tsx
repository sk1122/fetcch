  ...
  return (
    <section className="lg:custom-bg dark:bg-none">
      <div className="mx-auto min-h-[80vh] max-w-8xl px-4 sm:px-6 lg:px-8">
        <div className="mt-36 flex w-full flex-col justify-center text-center sm:mt-52">
          ...
          <h2 className="mt-4 px-6 text-lg font-semibold text-fetcch-dark dark:text-white lg:text-2xl">
