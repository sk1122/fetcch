            ...
            {bridges.map((bridge) => (
              <RadioGroup.Option
                ...
                className={({ checked }) =>
                  classNames(
                    checked
                      ? 'bg-fetcch-purple/5 border-fetcch-purple z-10'
                      : 'border-gray-200',
                    'relative border-2 p-4 mb-3 rounded-md flex flex-col cursor-pointer focus:outline-none'
                  )
                }
              >
                <>
                  {({ active }: { active: any }) => (
                    <div
                      className={classNames(
                        ...
                        'rounded-b-md bg-fetcch-purple px-2 text-xs text-white'
                      )}
                    >
                      Selected
                    </div>
                  ...
                  <div className="mb-4 grid grid-cols-9 rounded-md bg-gray-200/60 p-2 sm:px-8">
                    <div className="col-span-2 w-full ">
                      <div className="flex flex-col items-center space-x-2 sm:flex-row">
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          <span className="block font-semibold text-fetcch-purple/50 ">
                            USDC
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="flex w-full justify-between space-x-1">
                    <div className="rounded-md bg-gray-200/60 p-2 text-xs font-semibold sm:px-8 md:text-sm">
                      1 User Action
                    </div>
                    <div className="rounded-md bg-gray-200/60 p-2 text-xs font-semibold sm:px-8 md:text-sm">
                      $ 0.01 Gas Fee
