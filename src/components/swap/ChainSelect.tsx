...
export default function ChainSelect(params: IParams) {
  ...
  return (
    <Menu as="div" className="relative inline-block w-full text-left">
      <div>
        <Menu.Button className="inline-flex h-10 w-full items-center justify-between rounded-md bg-white px-4 py-2 text-sm font-medium text-fetcch-dark shadow-sm hover:bg-gray-50 focus:outline-none dark:bg-fetcch-dark/50">
          {params.chain ? (
      ...
      >
        <Menu.Items className="absolute inset-x-0 z-10 mt-2 w-full divide-y divide-fetcch-purple/50 rounded-md bg-white shadow-lg ring-black/5 focus:outline-none dark:border-fetcch-purple/30 dark:bg-fetcch-dark">
